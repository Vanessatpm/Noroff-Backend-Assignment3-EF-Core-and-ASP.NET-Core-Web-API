    ...
    public class FilmDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Character>().HasData(
               new Character() { CharacterId = 1, FullName = "Tony Stark", Alias = "Iron Man", Gender = "Male", PictureUrl = "https://www.imdb.com/title/tt0371746/mediaviewer/rm1006248448/", movieId = 1 },
               new Character() { CharacterId = 2, FullName = "Steve Rogers", Alias = "Captain America", Gender = "Male", PictureUrl = "https://www.imdb.com/title/tt0458339/mediaviewer/rm2483030016/", movieId = 1 },
               new Character() { CharacterId = 3, FullName = "Thor Odinson", Alias = "Thor", Gender = "Male", PictureUrl = "https://www.imdb.com/title/tt0800369/mediaviewer/rm1346871297/", movieId = 1 },
               new Character() { CharacterId = 4, FullName = "Luke Skywalker", Alias = "Jedi Knight", Gender = "Male", PictureUrl = "https://www.imdb.com/title/tt0076759/mediaviewer/rm2446233600/", movieId = 2 },
